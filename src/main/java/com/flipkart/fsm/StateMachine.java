...
import com.flipkart.fsm.core.entities.*;
import com.flipkart.fsm.core.executors.ErrorAction;
 ...
 *     While the core idea is the same (Duh! there is only one way to implement a state machine),
 *     good load of changes have been made to the abstractions and event transitions.
 *
 *     Also cued some up from {@rel https://github.com/Flipkart/kalpataru/tree/master/kalpataru-fsm}
 *
 *     Couldn't use either of 'em as it is, because of the volume of changes(constructs and abstractions)
